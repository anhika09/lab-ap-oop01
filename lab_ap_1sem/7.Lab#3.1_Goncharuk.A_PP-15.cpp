/*Тема - оператори циклу, та директриви препроцесора #define. Завдання - обчислення функції із заданими 
значеннями змінних із використанням різних операторів циклів for(), while(), do while()*/
#include <iostream>
#include <cmath>
#include <iomanip>
#define N 15
