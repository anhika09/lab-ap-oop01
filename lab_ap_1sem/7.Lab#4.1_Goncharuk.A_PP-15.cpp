/*Тема - одновимірні масиви, динамічна пам'ять. Завдання - для кожного елемента рандомного масиву 
визначити число його входжень (динамічна пам'ять через константу, цикли, підключення рандому в С++ )*/
#include <iostream>
#include <iomanip>
#include <ctime>
